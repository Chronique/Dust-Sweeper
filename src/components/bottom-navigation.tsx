...
export const BottomNavigation = ({ activeTab, onTabChange }: BottomNavigationProps) => {
  return (
    // WRAPPER FIXED: Nempel bawah, full width, handle notch iPhone
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white/90 dark:bg-black/90 backdrop-blur-lg border-t border-zinc-200 dark:border-zinc-800 pb-[env(safe-area-inset-bottom)]">
      ...
      {/* CONTAINER: Membatasi lebar agar icon tidak terlalu jauh di layar lebar */}
      <div className="flex justify-around items-center h-20 max-w-lg mx-auto px-2">
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center gap-1 transition-all duration-300 w-24 group ${
            activeTab === "swap" 
              ? "text-orange-600" 
